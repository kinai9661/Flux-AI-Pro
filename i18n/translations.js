...
export const TRANSLATIONS = {
  ...
  zh: {
    ...
    video_style_label: "影片風格",
    video_fps_label: "幀率 (FPS)",
    video_ref_img: "參考圖片 (Img2Vid) 📸",
    video_category_all: "全部模型",
    video_category_text: "文字轉影片",
    video_category_image: "圖片轉影片",
    video_recommended: "推薦",
    video_download: "💾 下載影片",
    video_history_title: "📚 影片歷史",
    video_no_history: "暫無影片歷史",
    video_clear_history: "🗑️ 清空歷史",
    video_export_history: "📥 導出歷史",
    video_import_history: "📤 匯入歷史",
    video_stat_total: "📊 總影片數",
    video_stat_storage: "💾 存儲空間",
    video_provider_pollinations_desc: "免費影片生成 API",
    video_provider_runway: "Runway ML",
    video_provider_runway_desc: "專業影片生成平台",
    video_provider_pika: "Pika Labs",
    video_provider_pika_desc: "快速影片生成",
    video_provider_luma: "Luma AI",
    video_provider_luma_desc: "高質量影片生成",
    video_provider_kling: "Kling AI",
    video_provider_kling_desc: "先進影片生成",
    video_model_svd_desc: "基於 Stable Diffusion 的影片生成模型",
    video_model_svd_xt_desc: "SVD 的增強版本，質量更高",
    video_model_animatediff_desc: "專注於動畫風格的影片生成",
    video_model_zeroscope_desc: "高質量影片生成模型",
    video_model_modelscope_desc: "ModelScope 影片生成模型",
    video_model_cogvideox_desc: "智譜 AI 的影片生成模型",
    video_model_seedance_pro_desc: "Seedance Pro 專業級影片生成模型",
    video_model_seedance_desc: "Seedance 高品質影片生成模型",
    video_model_wan_desc: "Wan 影片生成模型",
    video_model_gen2_desc: "Runway 的影片生成模型",
    video_model_gen2_img_desc: "圖片轉影片",
    video_model_pika_1_desc: "Pika Labs 的影片生成模型",
    video_model_pika_img_desc: "圖片轉影片",
    video_model_dream_machine_desc: "Luma AI 的影片生成模型",
    video_model_kling_v1_desc: "Kling AI 的影片生成模型",
    video_style_none: "無風格",
    video_style_cinematic: "電影風格",
    video_style_anime: "動漫風格",
    video_style_3d_render: "3D 渲染",
    video_style_watercolor: "水彩畫風",
    video_style_cyberpunk: "賽博龐克",
    video_style_nature: "自然風景",
    video_style_abstract: "抽象藝術",
    video_style_category_basic: "基礎風格",
    video_style_category_film: "電影風格",
    video_style_category_animation: "動畫風格",
    video_style_category_3d: "3D 風格",
    video_style_category_artistic: "藝術風格",
    video_style_category_scifi: "科幻風格",
    video_style_category_nature: "自然風格",
    video_size_square_480: "正方形 480p",
    video_size_square_720: "正方形 720p",
    video_size_landscape_480: "橫向 480p",
    video_size_landscape_720: "橫向 720p",
    video_size_portrait_480: "直向 480p",
    video_size_portrait_720: "直向 720p",
    video_size_wide_1080: "寬屏 1080p",
    video_generating_progress: "生成進度",
    video_generating_time: "已耗時",
    video_generating_eta: "預計剩餘",
    video_error_generation_failed: "影片生成失敗",
    video_error_api_error: "API 錯誤",
    video_error_timeout: "請求超時",
    video_error_rate_limit: "請求過於頻繁，請稍後再試",
    video_error_invalid_model: "無效的模型選擇",
    video_error_invalid_size: "無效的尺寸選擇",
    video_error_upload_failed: "圖片上傳失敗",
    video_tip: "💡 提示：選擇合適的模型和風格可以獲得更好的影片效果",
    video_quota_exceeded: "🎬 影片配額已用盡！每小時免費配額為 5 個影片。請 {waitMin} 分鐘後再試。",
  ...
  en: {
    ...
    video_model_svd: "SVD",
    video_model_svd_xt: "SVD-XT",
    video_model_seedance_pro_desc: "Professional-grade video generation model",
    video_model_seedance_desc: "High-quality video generation model",
    video_model_wan_desc: "Wan video generation model",
    video_provider_pollinations: "Pollinations.ai",
    video_quota_exceeded: "🎬 Video quota exceeded! Free quota is 5 videos per hour. Please try again in {waitMin} minutes.",
  ...
  ja: {
    ...
    video_model_svd: "SVD",
    video_model_svd_xt: "SVD-XT",
    video_model_seedance_pro_desc: "プロフェッショナルグレードの動画生成モデル",
    video_model_seedance_desc: "高品質の動画生成モデル",
    video_model_wan_desc: "Wan動画生成モデル",
    video_provider_pollinations: "Pollinations.ai",
    video_quota_exceeded: "🎬 動画のクォータが超過しました！無料クォータは1時間あたり5本です。{waitMin}分後にもう一度お試しください。",
  ...
  ko: {
    ...
    video_model_svd: "SVD",
    video_model_svd_xt: "SVD-XT",
    video_model_seedance_pro_desc: "프로페셔널급 동영상 생성 모델",
    video_model_seedance_desc: "고품질 동영상 생성 모델",
    video_model_wan_desc: "Wan 동영상 생성 모델",
    video_provider_pollinations: "Pollinations.ai",
  ...
  ar: {
    ...
    video_model_svd_xt: "SVD-XT",
    video_provider_pollinations: "Pollinations.ai",
    video_style_label: "نمط الفيديو",
    video_fps_label: "معدل الإطارات (FPS)",
    video_ref_img: "صورة مرجعية (Img2Vid) 📸",
    video_category_all: "جميع النماذج",
    video_category_text: "نص إلى فيديو",
    video_category_image: "صورة إلى فيديو",
    video_recommended: "موصى به",
    video_download: "💾 تنزيل الفيديو",
    video_history_title: "📚 سجل الفيديو",
    video_no_history: "لا يوجد سجل فيديو",
    video_clear_history: "🗑️ مسح السجل",
    video_export_history: "📥 تصدير السجل",
    video_import_history: "📤 استيراد السجل",
    video_stat_total: "📊 إجمالي الفيديوهات",
    video_stat_storage: "💾 مساحة التخزين",
    video_provider_pollinations_desc: "API إنشاء فيديو مجاني",
    video_provider_runway: "Runway ML",
    video_provider_runway_desc: "منصة إنشاء فيديو احترافية",
    video_provider_pika: "Pika Labs",
    video_provider_pika_desc: "إنشاء فيديو سريع",
    video_provider_luma: "Luma AI",
    video_provider_luma_desc: "إنشاء فيديو عالي الجودة",
    video_provider_kling: "Kling AI",
    video_provider_kling_desc: "إنشاء فيديو متقدم",
    video_model_svd_desc: "نموذج Stable Video Diffusion",
    video_model_svd_xt_desc: "SVD محسّن بجودة أعلى",
    video_model_animatediff_desc: "إنشاء فيديو يركز على الرسوم المتحركة",
    video_model_zeroscope_desc: "نموذج إنشاء فيديو عالي الجودة",
    video_model_modelscope_desc: "نموذج إنشاء فيديو ModelScope",
    video_model_cogvideox_desc: "نموذج إنشاء فيديو Zhipu AI",
    video_model_seedance_pro_desc: "نموذج إنشاء فيديو Seedance Pro احترافي",
    video_model_seedance_desc: "نموذج إنشاء فيديو Seedance عالي الجودة",
    video_model_wan_desc: "نموذج إنشاء فيديو Wan",
    video_model_gen2_desc: "نموذج إنشاء فيديو Runway",
    video_model_gen2_img_desc: "صورة إلى فيديو",
    video_model_pika_1_desc: "نموذج إنشاء فيديو Pika Labs",
    video_model_pika_img_desc: "صورة إلى فيديو",
    video_model_dream_machine_desc: "نموذج إنشاء فيديو Luma AI",
    video_model_kling_v1_desc: "نموذج إنشاء فيديو Kling AI",
    video_style_none: "بدون نمط",
    video_style_cinematic: "سينمائي",
    video_style_anime: "أنمي",
    video_style_3d_render: "عرض ثلاثي الأبعاد",
    video_style_watercolor: "ألوان مائية",
    video_style_cyberpunk: "سايبربانك",
    video_style_nature: "طبيعة",
    video_style_abstract: "تجريدي",
    video_style_category_basic: "أساسي",
    video_style_category_film: "سينمائي",
    video_style_category_animation: "رسوم متحركة",
    video_style_category_3d: "ثلاثي الأبعاد",
    video_style_category_artistic: "فني",
    video_style_category_scifi: "خيال علمي",
    video_style_category_nature: "طبيعة",
    video_size_square_480: "مربع 480p",
    video_size_square_720: "مربع 720p",
    video_size_landscape_480: "أفقي 480p",
    video_size_landscape_720: "أفقي 720p",
    video_size_portrait_480: "عمودي 480p",
    video_size_portrait_720: "عمودي 720p",
    video_size_wide_1080: "عريض 1080p",
    video_generating_progress: "تقدم الإنشاء",
    video_generating_time: "الوقت المنقضي",
    video_generating_eta: "الوقت المتبقي المقدر",
    video_error_generation_failed: "فشل إنشاء الفيديو",
    video_error_api_error: "خطأ في API",
    video_error_timeout: "انتهت مهلة الطلب",
    video_error_rate_limit: "طلبات كثيرة جدًا، يرجى المحاولة مرة أخرى لاحقًا",
    video_error_invalid_model: "اختيار نموذج غير صالح",
    video_error_invalid_size: "اختيار حجم غير صالح",
    video_error_upload_failed: "فشل رفع الصورة",
    video_tip: "💡 نصيحة: اختيار النموذج والنمط المناسبين يمكن أن ينتج نتائج فيديو أفضل",
    video_quota_exceeded: "🎬 تم تجاوز حصة الفيديو! الحصة المجانية هي 5 فيديوهات في الساعة. يرجى المحاولة مرة أخرى بعد {waitMin} دقيقة.",
